...
const Banner = () => {
    return (
        <div className="hero" style={{ backgroundImage: `url(${bgBanner})` }}>
            <div className="flex flex-col items-center w-3/4 lg:flex-row-reverse py-12 max-w-7xl mx-auto lg:justify-around">
                ...
                <div className='lg:mr-28'>
                    ...
                    <a href="#_" className="lg:ml-1 relative inline-block px-4 py-2 font-medium group">
                        ...
                        <span className="relative text-[#ffff] group-hover:text-[#ffff]">Get Started</span>
                    </a>
                </div>
            </div>
        </div >
